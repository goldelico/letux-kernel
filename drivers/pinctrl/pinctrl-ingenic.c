...
static const struct group_desc x1600_groups[] = {
	INGENIC_PIN_GROUP("uart0-data", x1600_uart0_data),
	INGENIC_PIN_GROUP("uart0-hwflow", x1600_uart0_hwflow),
	INGENIC_PIN_GROUP("uart1-data", x1600_uart1_data),
	INGENIC_PIN_GROUP("uart1-hwflow", x1600_uart1_hwflow),
	INGENIC_PIN_GROUP("uart2-data-a", x1600_uart2_data_a),
	INGENIC_PIN_GROUP("uart2-data-b", x1600_uart2_data_b),
	INGENIC_PIN_GROUP("uart3-data-b", x1600_uart3_data_b),
	INGENIC_PIN_GROUP("uart3-data-d", x1600_uart3_data_d),
	INGENIC_PIN_GROUP("sfc", x1600_sfc),
	INGENIC_PIN_GROUP("ssi-dt-a", x1600_ssi_dt_a),
	INGENIC_PIN_GROUP("ssi-dt-b", x1600_ssi_dt_b),
	INGENIC_PIN_GROUP("ssi-dr-a", x1600_ssi_dr_a),
	INGENIC_PIN_GROUP("ssi-dr-b", x1600_ssi_dr_b),
	INGENIC_PIN_GROUP("ssi-clk-a", x1600_ssi_clk_a),
	INGENIC_PIN_GROUP("ssi-clk-b", x1600_ssi_clk_b),
	INGENIC_PIN_GROUP("ssi-ce0-a", x1600_ssi_ce0_a),
	INGENIC_PIN_GROUP("ssi-ce0-b", x1600_ssi_ce0_b),
	INGENIC_PIN_GROUP("ssi-ce1-a", x1600_ssi_ce1_a),
	INGENIC_PIN_GROUP("ssi-ce1-b", x1600_ssi_ce1_b),
	INGENIC_PIN_GROUP("mmc0-1bit-b", x1600_mmc0_1bit_b),
	INGENIC_PIN_GROUP("mmc0-4bit-b", x1600_mmc0_4bit_b),
	INGENIC_PIN_GROUP("mmc0-1bit-c", x1600_mmc0_1bit_c),
	INGENIC_PIN_GROUP("mmc0-4bit-c", x1600_mmc0_4bit_c),
	INGENIC_PIN_GROUP("mmc1-1bit", x1600_mmc1_1bit),
	INGENIC_PIN_GROUP("mmc1-4bit", x1600_mmc1_4bit),
	INGENIC_PIN_GROUP("i2c0-data-a", x1600_i2c0_a),
	INGENIC_PIN_GROUP("i2c0-data-b", x1600_i2c0_b),
	INGENIC_PIN_GROUP("i2c1-data-b-15", x1600_i2c1_b_15),
	INGENIC_PIN_GROUP("i2c1-data-b-19", x1600_i2c1_b_19),
	INGENIC_PIN_GROUP("i2s-data-tx", x1600_i2s_data_tx),
	INGENIC_PIN_GROUP("i2s-data-rx", x1600_i2s_data_rx),
	INGENIC_PIN_GROUP("i2s-clk-rx", x1600_i2s_clk_rx),
	...
	{ "lcd-no-pins", },
	INGENIC_PIN_GROUP("pwm0", x1600_pwm_pwm0),
	INGENIC_PIN_GROUP("pwm1", x1600_pwm_pwm1),
	INGENIC_PIN_GROUP("pwm2", x1600_pwm_pwm2),
	INGENIC_PIN_GROUP("pwm3", x1600_pwm_pwm3),
	INGENIC_PIN_GROUP("pwm4", x1600_pwm_pwm4),
	INGENIC_PIN_GROUP("pwm5", x1600_pwm_pwm5),
	INGENIC_PIN_GROUP("pwm6", x1600_pwm_pwm6),
	INGENIC_PIN_GROUP("pwm7", x1600_pwm_pwm7),
	INGENIC_PIN_GROUP("mac", x1600_mac),
};

static const char *x1600_uart0_groups[] = { "uart0-data", "uart0-hwflow", };
static const char *x1600_uart1_groups[] = { "uart1-data", "uart1-hwflow", };
static const char *x1600_uart2_groups[] = { "uart2-data-a", "uart2-data-b", };
static const char *x1600_uart3_groups[] = { "uart3-data-b", "uart3-data-d", };
static const char *x1600_sfc_groups[] = { "sfc", };
static const char *x1600_ssi_groups[] = {
	"ssi-dt-a", "ssi-dt-b",
	"ssi-dr-a", "ssi-dr-b",
	"ssi-clk-a", "ssi-clk-b",
	"ssi-ce0-a", "ssi-ce0-b",
...
static const char *x1600_i2s_groups[] = {
...
static const char *x1600_pwm3_groups[] = { "pwm3", };
static const char *x1600_pwm4_groups[] = { "pwm4", };
static const char *x1600_pwm5_groups[] = { "pwm5", };
static const char *x1600_pwm6_groups[] = { "pwm6", };
static const char *x1600_pwm7_groups[] = { "pwm7", };
static const char *x1600_mac_groups[] = { "mac", };
...
static const struct function_desc x1600_functions[] = {
	...
	{ "ssi", x1600_ssi_groups, ARRAY_SIZE(x1600_ssi_groups), },
	{ "mmc0", x1600_mmc0_groups, ARRAY_SIZE(x1600_mmc0_groups), },
	{ "mmc1", x1600_mmc1_groups, ARRAY_SIZE(x1600_mmc1_groups), },
	{ "i2c0", x1600_i2c0_groups, ARRAY_SIZE(x1600_i2c0_groups), },
	{ "i2c1", x1600_i2c1_groups, ARRAY_SIZE(x1600_i2c1_groups), },
	{ "i2s", x1600_i2s_groups, ARRAY_SIZE(x1600_i2s_groups), },
	{ "cim", x1600_cim_groups, ARRAY_SIZE(x1600_cim_groups), },
	{ "lcd", x1600_lcd_groups, ARRAY_SIZE(x1600_lcd_groups), },
	{ "pwm0", x1600_pwm0_groups, ARRAY_SIZE(x1600_pwm0_groups), },
	{ "pwm1", x1600_pwm1_groups, ARRAY_SIZE(x1600_pwm1_groups), },
	{ "pwm2", x1600_pwm2_groups, ARRAY_SIZE(x1600_pwm2_groups), },
	{ "pwm3", x1600_pwm3_groups, ARRAY_SIZE(x1600_pwm3_groups), },
	{ "pwm4", x1600_pwm4_groups, ARRAY_SIZE(x1600_pwm4_groups), },
	{ "pwm5", x1600_pwm5_groups, ARRAY_SIZE(x1600_pwm5_groups), },
	{ "pwm6", x1600_pwm6_groups, ARRAY_SIZE(x1600_pwm6_groups), },
	{ "pwm7", x1600_pwm7_groups, ARRAY_SIZE(x1600_pwm7_groups), },
	{ "mac", x1600_mac_groups, ARRAY_SIZE(x1600_mac_groups), },
};
...
static const struct of_device_id ingenic_pinctrl_of_match[] = {
	...
	{ .compatible = "ingenic,x1600-pinctrl", .data = &x1600_chip_info },
