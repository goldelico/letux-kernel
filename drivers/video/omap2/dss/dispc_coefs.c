...
const struct dispc_coef *dispc_ovl_get_scale_coef(int inc, int five_taps)
{
	...
	/*
	 * When upscaling more than two times, blockiness and outlines around
	 * the image are observed when M8 tables are used. M11, M16 and M19
	...
	return five_taps ? coef5_M19 : coef3_M19;
}
