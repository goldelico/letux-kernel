...
#define ISPCSI1_SYSCONFIG_MSTANDBY_MODE_SHIFT	12
#define ISPCSI1_SYSCONFIG_MSTANDBY_MODE_MASK	0x3
#define ISPCSI1_SYSCONFIG_MSTANDBY_MODE_FORCE		\
	(0x0 << ISPCSI2_SYSCONFIG_MSTANDBY_MODE_SHIFT)
#define ISPCSI1_SYSCONFIG_MSTANDBY_MODE_NO		\
	(0x1 << ISPCSI2_SYSCONFIG_MSTANDBY_MODE_SHIFT)
#define ISPCSI1_SYSCONFIG_MSTANDBY_MODE_SMART		\
	(0x2 << ISPCSI2_SYSCONFIG_MSTANDBY_MODE_SHIFT)
#define ISPCSI1_SYSCONFIG_SOFT_RESET	(1 << 1)
#define ISPCSI1_SYSCONFIG_AUTO_IDLE	(1 << 0)


#define ISPCSI1_SYSSTATUS		(0x008)
#define ISPCSI1_SYSSTATUS_RESET_DONE	(1 << 0)
...
#define ISPCSI1_LCM_IRQSTATUS_LCM_OCPERROR	(1 << 1)
#define ISPCSI1_LCM_IRQSTATUS_LCM_EOF		(1 << 0)

#define ISPCSI1_CTRL			(0x040)
#define ISPCSI1_CTRL_FRACDIV_SHIFT	 15
#define ISPCSI1_CTRL_FRACDIV_MASK	(0xFFFF8 << ISPCSI1_CTRL_FRACDIV_SHIFT)
#define ISPCSI1_CTRL_POSTED			(1 << 14)
#define ISPCSI1_CTRL_DBG_EN			(1 << 13)
#define ISPCSI1_CTRL_VP_CLK_POL		(1 << 12)
#define ISPCSI1_CTRL_VP_ONLY_EN		(1 << 11)
#define ISPCSI1_CTRL_INV		(1 << 10)
#define ISPCSI1_CTRL_VP_OUT_CTRL_SHIFT	8
#define ISPCSI1_CTRL_VP_OUT_CTRL_MASK	0x3
#define ISPCSI1_CTRL_BURST_SHIFT	5
#define ISPCSI1_CTRL_BURST_MASK		0x3
#define ISPCSI1_CTRL_MODE_CCP2		(1 << 4)
#define ISPCSI1_CTRL_FRAME		(1 << 3)
#define ISPCSI1_CTRL_IO_OUT_SEL		(1 << 2)
#define ISPCSI1_CTRL_PHY_SEL		(1 << 1)
#define ISPCSI1_CTRL_IF_EN		(1 << 0)

#define ISPCSI1_DBG			(0x044)
#define ISPCSI1_GNQ			(0x048)
#define ISPCSI1_GNQ_FIFODEPTH_SHIFT	2
#define ISPCSI1_GNQ_FIFODEPTH_MASK	0x7
#define ISPCSI1_GNQ_NBCHANNELS_SHIFT	0
#define ISPCSI1_GNQ_NBCHANNELS_MASK	0x3

#define ISPCSI1_CTRL1			(0x04C)

#define ISPCSI1_LCx_CTRL(x)		((0x050)+0x30*(x))
#define ISPCSI1_LCx_CTRL_COUNT_SHIFT	24
#define ISPCSI1_LCx_CTRL_COUNT_MASK	0xFF
#define ISPCSI1_LCx_CTRL_DPCM_PRED	(1 << 18)
#define ISPCSI1_LCx_CTRL_PING_PONG	(1 << 17)
#define ISPCSI1_LCx_CTRL_COUNT_UNLOCK	(1 << 16)
#define ISPCSI1_LCx_CTRL_ALPHA_SHIFT	8
#define ISPCSI1_LCx_CTRL_ALPHA_MASK	0xFF
#define ISPCSI1_LCx_CTRL_FORMAT_SHIFT	3
#define ISPCSI1_LCx_CTRL_FORMAT_MASK	0x1F
#define ISPCSI1_LCx_CTRL_CRC_EN		(1 << 2)
#define ISPCSI1_LCx_CTRL_REGION_EN	(1 << 1)
#define ISPCSI1_LCx_CTRL_CHAN_EN	(1 << 0)
...
#define ISPCSI1_LCx_DAT_START_VERT_SHIFT	16
#define ISPCSI1_LCx_DAT_START_VERT_MASK		0xFFF

#define ISPCSI1_LCx_DAT_SIZE(x)		((0x06C)+0x30*(x))
#define ISPCSI1_LCx_DAT_SIZE_VERT_SHIFT		16
#define ISPCSI1_LCx_DAT_SIZE_VERT_MASK		0xFFF
...
#define ISPCSI1_LCM_CTRL_DST_DECOMPR_SHIFT	28
#define ISPCSI1_LCM_CTRL_DST_DECOMPR_MASK	0x3
#define ISPCSI1_LCM_CTRL_DST_FORMAT_SHIFT	24
#define ISPCSI1_LCM_CTRL_DST_FORMAT_MASK	0x7
#define ISPCSI1_LCM_CTRL_SRC_DECOMPR_SHIFT	20
#define ISPCSI1_LCM_CTRL_SRC_DECOMPR_MASK	0x3
#define ISPCSI1_LCM_CTRL_SRC_FORMAT_SHIFT	16
#define ISPCSI1_LCM_CTRL_SRC_FORMAT_MASK	0x7
#define ISPCSI1_LCM_CTRL_BURST_SIZE_SHIFT	5
#define ISPCSI1_LCM_CTRL_BURST_SIZE_MASK	0x7
#define ISPCSI1_LCM_CTRL_DST_PORT_MEM	(1 << 2)
#define ISPCSI1_LCM_CTRL_CHAN_EN	0x1

#define ISPCSI1_LCM_VSIZE		(0x1D4)
#define ISPCSI1_LCM_VSIZE_COUNT_SHIFT	16
#define ISPCSI1_LCM_VSIZE_COUNT_MASK	0x1FFF
#define ISPCSI1_LCM_VSIZE_SKIP_SHIFT	0
#define ISPCSI1_LCM_VSIZE_SKIP_MASK	0x1FFF

#define ISPCSI1_LCM_HSIZE		(0x1D8)
#define ISPCSI1_LCM_HSIZE_COUNT_SHIFT	16
#define ISPCSI1_LCM_HSIZE_COUNT_MASK	0x1FFF
#define ISPCSI1_LCM_HSIZE_SKIP_SHIFT	0
#define ISPCSI1_LCM_HSIZE_SKIP_MASK	0x1FFF

#define ISPCSI1_LCM_PREFETCH		(0x1DC)
#define ISPCSI1_LCM_PREFETCH_HWORDS_SHIFT	3
#define ISPCSI1_LCM_PREFETCH_HWORDS_MASK	0x7FF
...
#define ISPPRV_HORZ_INFO_EPH_MASK	(0x3fff << ISPPRV_HORZ_INFO_EPH_SHIFT)
#define ISPPRV_HORZ_INFO_SPH_SHIFT	16
#define ISPPRV_HORZ_INFO_SPH_MASK	(0x3fff << ISPPRV_HORZ_INFO_SPH_SHIFT)

#define ISPPRV_VERT_INFO_ELV_SHIFT	0
#define ISPPRV_VERT_INFO_ELV_MASK	(0x3fff << ISPPRV_VERT_INFO_ELV_SHIFT)
#define ISPPRV_VERT_INFO_SLV_SHIFT	16
#define ISPPRV_VERT_INFO_SLV_MASK	(0x3fff << ISPPRV_VERT_INFO_SLV_SHIFT)
...
#define IRQ0ENABLE_CSIB_LCM_IRQ			(1 << 3)
#define IRQ0ENABLE_CSIB_LC0_IRQ			(1 << 4)
...
#define IRQ0STATUS_CSIC_IRQ			(1 << 2)
#define IRQ0STATUS_CSIB_LCM_IRQ			(1 << 3)
#define IRQ0STATUS_CSIB_LC0_IRQ			(1 << 4)
...
#define ISPCTRL_SBL_CBUFF0_BCF_CTRL_SHIFT	22
#define ISPCTRL_SBL_CBUFF0_BCF_CTRL_STALL_RESPONSE	(0x1 << \
					ISPCTRL_SBL_CBUFF0_BCF_CTRL_SHIFT)
#define ISPCTRL_SBL_CBUFF0_BCF_CTRL_STALL_REQUEST	(0x2 << \
					ISPCTRL_SBL_CBUFF0_BCF_CTRL_SHIFT)
#define ISPCTRL_SBL_CBUFF0_BCF_CTRL_MASK	0x3
#define ISPCTRL_SBL_CBUFF1_BCF_CTRL_SHIFT	24
#define ISPCTRL_SBL_CBUFF1_BCF_CTRL_STALL_RESPONSE	(0x1 << \
					ISPCTRL_SBL_CBUFF1_BCF_CTRL_SHIFT)
#define ISPCTRL_SBL_CBUFF1_BCF_CTRL_STALL_REQUEST	(0x2 << \
					ISPCTRL_SBL_CBUFF1_BCF_CTRL_SHIFT)
#define ISPCTRL_SBL_CBUFF1_BCF_CTRL_MASK	0x3
...
#define ISPRSZ_HFILT_COEF0_MASK			0x3FF
#define ISPRSZ_HFILT_COEF1_SHIFT		16
#define ISPRSZ_HFILT_COEF1_MASK			0x3FF

#define ISPRSZ_VFILT_COEF0_SHIFT		0
#define ISPRSZ_VFILT_COEF0_MASK			0x3FF
#define ISPRSZ_VFILT_COEF1_SHIFT		16
#define ISPRSZ_VFILT_COEF1_MASK			0x3FF
