...
static int retrode3_snes_probe(struct retrode3_slot *dev)
{
...
static int retrode3_snes_remove(struct retrode3_slot *dev)
{
	/* cleanup */
	return 0;
}
...
static struct retrode3_slot_driver retrode3_snes_driver = {
...
{
	printk("%s %d\n", __func__, __LINE__);
	return retrode3_slot_driver_register(&retrode3_snes_driver);
}
static void __exit retrode3_snes_exit(void)
{
	retrode3_slot_driver_unregister(&retrode3_snes_driver);
}
