...
static int retrode3_nes_probe(struct retrode3_slot *dev)
{
...
static int retrode3_nes_remove(struct retrode3_slot *dev)
{
	/* cleanup */
	return 0;
}
...
static struct retrode3_slot_driver retrode3_nes_driver = {
...
{
	printk("%s %d\n", __func__, __LINE__);
	return retrode3_slot_driver_register(&retrode3_nes_driver);
}
static void __exit retrode3_nes_exit(void)
{
	retrode3_slot_driver_unregister(&retrode3_nes_driver);
}
