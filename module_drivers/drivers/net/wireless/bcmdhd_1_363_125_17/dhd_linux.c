 ...
 *
 * $Id: dhd_linux.c 709615 2019-02-15 07:37:37Z $
 */
...
bool dhd_update_fw_nv_path(dhd_info_t *dhdinfo)
{
	...
	if (!dhd_download_fw_on_driverload) {
#ifdef CONFIG_BCMDHD_1_363_125_17_FW_PATH
		fw = CONFIG_BCMDHD_1_363_125_17_FW_PATH;
#endif /* CONFIG_BCMDHD_1_363_125_17_FW_PATH */
#ifdef CONFIG_BCMDHD_1_363_125_17_NVRAM_PATH
		nv = CONFIG_BCMDHD_1_363_125_17_NVRAM_PATH;
#endif /* CONFIG_BCMDHD_1_363_125_17_NVRAM_PATH */
	}
...
write_to_file(dhd_pub_t *dhd, uint8 *buf, int size)
{
	...
	sprintf(memdump_path, "%s_%s_%ld.%ld", "/installmedia/mem_dump",
		memdump_type, (unsigned long)curtime.time.tv_sec,
		(unsigned long)curtime.time.tv_usec);
