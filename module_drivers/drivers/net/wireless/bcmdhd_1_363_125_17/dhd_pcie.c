...
#define CONFIG_ANDROID_BCMDHD_1_363_125_17_FW_PATH "/vendor/firmware/broadcom/dhd/firmware/fw.bin.trx"
#define CONFIG_ANDROID_BCMDHD_1_363_125_17_NVRAM_PATH "/vendor/firmware/broadcom/dhd/nvrams/nvm.txt"
...
dhdpcie_download_firmware(struct dhd_bus *bus, osl_t *osh)
{
	...
	snprintf(bus->nv_path, sizeof(nv_path), "%s", CONFIG_ANDROID_BCMDHD_1_363_125_17_NVRAM_PATH);
	/* load firmware */
	snprintf(bus->fw_path, sizeof(fw_path), "%s", CONFIG_ANDROID_BCMDHD_1_363_125_17_FW_PATH);
