...
#define CONFIG_ANDROID_BCMDHD_1_363_125_17_FW_PATH "broadcom/dhd/firmware/fw.bin.trx"
#define CONFIG_ANDROID_BCMDHD_1_363_125_17_NVRAM_PATH "broadcom/dhd/nvrams/nvm.txt"
...
dbus_get_fwfile(int devid, int chiprev, uint8 **fw, int *fwlen, uint16 boardtype, uint16 boardrev)
{
	...
	snprintf(file_name, sizeof(file_name), "%s", CONFIG_ANDROID_BCMDHD_1_363_125_17_FW_PATH);
...
dbus_get_nvfile(int devid, int chiprev, uint8 **fw, int *fwlen, uint16 boardtype, uint16 boardrev)
{
	...
	snprintf(file_name, sizeof(file_name), "%s", CONFIG_ANDROID_BCMDHD_1_363_125_17_NVRAM_PATH);
