...
static int ingenic_dma_terminate_all(struct dma_chan *chan)
{
	...
	if(dmac->slave_id == INGENIC_DMA_REQ_AIC_LOOP_RX || dmac->slave_id == INGENIC_DMA_REQ_AIC_TX || dmac->slave_id == INGENIC_DMA_REQ_ASOC_AIC_RX
	|| dmac->slave_id == INGENIC_DMA_REQ_ASOC_AIC_TX || dmac->slave_id == INGENIC_DMA_REQ_AIC_F_RX || dmac->slave_id == INGENIC_DMA_REQ_DMIC_RX)
	{
