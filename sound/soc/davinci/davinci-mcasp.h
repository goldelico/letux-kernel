...
#define MCASP_V4_REVMINOR_MASK		(0x1f)
#define MCASP_V4_REVMAJOR_MASK		(0x3 << 8)
#define MCASP_V4_REVISION_MASK		(MCASP_V4_REVMAJOR_MASK | \
					 MCASP_V4_REVMINOR_MASK)
#define MCASP_V4_REVISION(maj, min)	((maj) << 8 | (min))
