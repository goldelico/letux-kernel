...
static const struct snd_kcontrol_new sun8i_aif3_loopback_switch =
	SOC_DAPM_SINGLE("AIF3 Loopback Switch",
...
static const struct snd_soc_dapm_widget sun8i_codec_dapm_widgets[] = {
	...
	SND_SOC_DAPM_SWITCH("AIF3 ADC Loopback", SND_SOC_NOPM, 0, 0,
	...
	/* AIF "ADC" Muxes */
	SND_SOC_DAPM_MUX("AIF3 ADC Mux", SND_SOC_NOPM, 0, 0,
	...
	SND_SOC_DAPM_SUPPLY("AIF3CLK", SUN8I_AIF3_PATH_CTRL,
			    SUN8I_AIF3_PATH_CTRL_AIF3_PINS_TRI, 1, NULL, 0),
};
...
static const struct snd_soc_dapm_route sun8i_codec_dapm_routes[] = {
	...
	{ "AIF3 ADC Loopback", "AIF3 Loopback Switch", "AIF3 ADC" },
	...
	{ "AIF3 ADC", NULL, "AIF3 ADC Mux" },

	{ "AIF3 ADC", NULL, "AIF3CLK" },
	...
	/* AIF "ADC" Mux Routes */
	{ "AIF3 ADC Mux", "AIF2 Left", "AIF2 ADC Left Mixer" },
	{ "AIF3 ADC Mux", "AIF2 Right", "AIF2 ADC Right Mixer" },
	...
	{ "AIF3 DAC", NULL, "AIF3 ADC Loopback" },

	{ "AIF3 DAC", NULL, "AIF3CLK" },
