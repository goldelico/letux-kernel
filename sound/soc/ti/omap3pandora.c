...
#include <linux/gpio.h>	  // CHECKME - do we need this or is gpio/consumer.h sufficient?
...
static void omap3pandora_remove(struct platform_device *pdev)
{
	...
	/* Da oben devm_snd_soc_register_card genutzt wird, */
	/* entfällt das manuelle snd_soc_unregister_card(card) hier. */
