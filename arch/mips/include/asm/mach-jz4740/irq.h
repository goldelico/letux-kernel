...
#if defined(CONFIG_MACH_JZ4740) || defined(CONFIG_MACH_JZ4730)
...
#define JZ4730_IRQ_PS2		JZ4740_IRQ(2)
#define JZ4730_IRQ_UPRT		JZ4740_IRQ(3)
#define JZ4730_IRQ_UART3	JZ4740_IRQ(6)
#define JZ4730_IRQ_UART2	JZ4740_IRQ(7)
#define JZ4730_IRQ_SCC1		JZ4740_IRQ(10)
#define JZ4730_IRQ_SCC0		JZ4740_IRQ(11)
#define JZ4730_IRQ_UDC		JZ4740_IRQ(12)
#define JZ4730_IRQ_UHC		JZ4740_IRQ(13)
#define JZ4730_IRQ_FIR		JZ4740_IRQ(16)
#define JZ4730_IRQ_SSI		JZ4740_IRQ(17)
#define JZ4730_IRQ_CIM		JZ4740_IRQ(18)
#define JZ4730_IRQ_AIC		JZ4740_IRQ(20)
#define JZ4730_IRQ_DMAC		JZ4740_IRQ(21)
#define JZ4730_IRQ_OST2		JZ4740_IRQ(22)
#define JZ4730_IRQ_OST1		JZ4740_IRQ(23)
#define JZ4730_IRQ_OST0		JZ4740_IRQ(24)
