/*
 * This is a temporary solution until there are no external references to jz4740_clock_bdata
 * patches are already circulating but not upstream
 * It is likely to become obsolete after DT support for jz47xx is given
 */


/*
 * linux/arch/mips/jz4740/board-generic.c
 *
...
{
#if 0	// not needed for DT - should be done by pinctrl
...
{
	printk(KERN_INFO "Mini PC JZ4730 setup\n");
