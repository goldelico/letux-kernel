...
static struct omap_device_pad default_omap4_uart4_pads[] __initdata = {
	{
		.name	= "uart4_cts.uart4_cts",
		.enable	= OMAP_PIN_INPUT_PULLUP | OMAP_MUX_MODE0,
	},
	{
		.name	= "uart4_rts.uart4_rts",
		.enable	= OMAP_PIN_OUTPUT | OMAP_MUX_MODE0,
	},
	{
...
static struct omap_device_pad default_uart6_pads[] __initdata = {
	{
		.name	= "uart6_cts.uart6_cts",
		.enable	= OMAP_PIN_INPUT_PULLUP | OMAP_MUX_MODE0,
	},
	{
		.name	= "uart6_rts.uart6_rts",
		.enable	= OMAP_PIN_OUTPUT | OMAP_MUX_MODE0,
	},
	{
		.name	= "uart6_tx.uart6_tx",
		.enable	= OMAP_PIN_OUTPUT | OMAP_MUX_MODE0,
	},
	{
		.name	= "uart6_rx.uart6_rx",
		.flags	= OMAP_DEVICE_PAD_REMUX | OMAP_DEVICE_PAD_WAKEUP,
		.enable	= OMAP_PIN_INPUT_PULLUP | OMAP_MUX_MODE0,
		.idle	= OMAP_PIN_INPUT_PULLUP | OMAP_MUX_MODE0,
	},
...
static void omap_serial_fill_default_pads(struct omap_board_data *bdata)
{
	...
	case 4:
		...
		break;
	case 5:
		bdata->pads = default_uart6_pads;
		bdata->pads_cnt = ARRAY_SIZE(default_uart6_pads);
		break;
	default:
		break;
	}
...
void __init omap_serial_init_port(struct omap_board_data *bdata)
{
	...
	if (((cpu_is_omap34xx() || cpu_is_omap44xx() || cpu_is_omap54xx())
			&& bdata->pads) || (pdata->wk_en && pdata->wk_mask))
